...
## Table of Contents
- [1️⃣ Take / Not-Take Pattern](#1️⃣-take--not-take-subset-style)
  - [Pattern Template](#pattern)
  - [Example Problems](#examples)
- [2️⃣ Permutation / Arrangement Pattern](#2️⃣-permutation--arrangement-order-matters)
  - [Pattern Template](#pattern-1)
  - [Example Problems](#examples-1)
- [3️⃣ Divide and Conquer Pattern](#3️⃣-divide-and-conquer)
  - [Pattern Template](#pattern-2)
  - [Example Problems](#examples-2)
- [4️⃣ DFS / Exploration Pattern](#4️⃣-dfs--exploration-graph-or-grid-traversal)
  - [Pattern Template](#pattern-3)
  - [Example Problems](#examples-3)
- [5️⃣ Recursive Building / Backtracking](#5️⃣-recursive-building--backtracking-generate-all-combinations)
  - [Pattern Template](#pattern-4)
  - [Example Problems](#examples-4)
- [⚙️ Hybrid Patterns](#️-hybrid-patterns)
- [🧾 Pattern Summary Table](#-summary-table)
